...
export const WHOLE_SCOPE_SELECTORS = ['operationTypes', 'persistenceTypes', 'destinationProductionIds', 'productionRelationships', 'businessPurposes', 'reuseIntents', 'distribution', 'audiences', 'toolEnvironmentIds', 'modelIds', 'deploymentTypes', 'providerTrainingValues', 'processingRegions', 'accessGroupIds', 'jurisdictions'];
