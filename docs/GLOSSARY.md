...
**Decision owner** — The person accountable for the outcome and its review path. The owner may differ from the requester or data steward.

**Derivative** — Any artefact created from source material, including transcripts, summaries, labels, embeddings, indexes, outputs, datasets, adapters and model weights.

**Environment** — The actual tool configuration and processing boundary: provider, model, tenant, account, regions, access, retention, deletion and provider use.
...
**Source** — The exact material, provenance, production context, contents and classifications involved in a proposed use.
